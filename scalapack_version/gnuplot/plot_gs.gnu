...
plot "./results/eig_H_2.txt" u 1:2 w l title "N=2", \
     ...
     f(x) title "Mean field" dt 2 linecolor rgb "black"

set output "./gnuplot/gs_I.pdf"
plot "./results/eig_I_2.txt" u 1:2 w l title "N=2", \
     ...
     "./results/eig_I_9.txt" u 1:2 w l title "N=9", \
     "./results/eig_I_10.txt" u 1:2 w l title "N=10", \
     g(x) title "Mean field" dt 2 linecolor rgb "black"
